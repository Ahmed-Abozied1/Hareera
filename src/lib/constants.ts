...
export const PRODUCTS_DATA = {
  inside: [
    {
      id: "1",
      name: "طقم بيجامة ساتان",
      description: "طقم نوم ساتان حريمي ناعم ومريح بمقاسات S / M / L / XL",
      type: "طقم نوم",
      beneficiaries: "S-XL",
      price: 20000,
      image: "/images/products/sheep.webp",
      category: "بيجامات وأطقم نوم",
      location: "INSIDE_EGYPT"
    },
    {
      id: "2",
      name: "روب وقميص نوم",
      description: "روب حريمي أنيق مع قميص نوم بخامة ناعمة بمقاسات S / M / L / XL",
      type: "روب",
      beneficiaries: "S-XL",
      price: 100000,
      image: "/images/products/cow.webp",
      category: "روبات وقمصان نوم",
      location: "INSIDE_EGYPT"
    },
  ],
  outside: [
